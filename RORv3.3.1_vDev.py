...
#RORv3.3.1 - Environmental Flows were added (using the formula given by WAPDA in Harpo Report)

#To Do
#Environmental Flow input should be taken out and connected with the tool interface.
...
def flowint_to_Q(flowint_folder,subbasin,flowint,year,month,day,hr,time_range,year1,month1,day1,hr1):
    ...
    e_flow = flowint_q.min()*0.25 #E flow added #Need to add this to inputs
    return ((flowint_q) - e_flow)
...
wkspace = 'D:/Cloud/GoogleDrive/Research/Masters/test_applications/kunhar' #Change
os.chdir(wkspace)
...
#==================================Inputs======================================
inDEM = arcpy.Raster('D:/Cloud/GoogleDrive/Research/Masters/test_applications/kunhar/Input/DEM.tif')                                               #Change
outlet = 'D:/Cloud/GoogleDrive/Research/Masters/test_applications/kunhar/Input/outlet.shp'
...
Protected_Area_Switch = 'false' #Should Always be lowercase
inWDPA = 'C:/Cloud/GoogleDrive/Research/Masters/4_Hydropower_Potential_Tools/Methodology/RORHydro_tool_run/mode_2_70Q/Input/WDPA_polygons.shp'                                    
Protected_Area_Buffer = '5000'                                 

mode = "Approach (i): Using only Topographic Factors (Only Site Selection)"
#mode0 - "Approach (i): Using only Topographic Factors (Only Site Selection)"
#mode1 - "Approach (i): Using only Topographic Factors (Hydropower Potential Evaluation)"
#mode2 - "Appraoch (ii): Using both Topographic and Hydrological Factors (For use with WEB-DHM)"

inSubbasin = 'C:/Cloud/GoogleDrive/Research/Masters/4_Hydropower_Potential_Tools/Methodology/RORHydro_tool_run/mode_2_70Q/Input/subbasin'                              
inFlowInt = 'C:/Cloud/GoogleDrive/Research/Masters/4_Hydropower_Potential_Tools/Methodology/RORHydro_tool_run/mode_2_70Q/Input/flowint'                            
river_folder = 'C:/Cloud/GoogleDrive/Research/Masters/4_Hydropower_Potential_Tools/Methodology/RORHydro_tool_run/mode_2_70Q/Input/flowint_pkl'                                 

input_start_date = '01/01/1978'
input_end_date = '12/31/1998'
...
minimum_hydropower_potential = '2'
maximum_hydropower_potential = '25'
#==============================================================================
...
print("DEM Resolution is " + str(resolution) + " meters")
print("Cell area is " + str(cellsize/1000000) + " sq. km")
...
print("Buffering World Database for Protected Areas...")
...
if mode == "Approach (i): Using only Topographic Factors (Only Site Selection)":
    print("Initializing Run-of-River Site Selection Module (" + mode +")")
    ...
    for streamorder in streamorders[3:]:
        ...
        for streamseg in streamsegs:
            ...
            while i < count:
                print("Processing SO " + str(streamorder) + 
                ...
                with arcpy.da.SearchCursor(inPoints, ["FID", "mem_point1", "Point_X", "Point_Y", "FAC", "DEM"], "FID = " + str(i)) as cursor1:
                    for row1 in cursor1:
                        ...
                        if total_alternatives == 0:
                            print('No Suitable Diversion Site')
                            ...
                            print("Head = " + str(head_fin) + " m")
                            print("Flow Accumulation = " + str(fac3) + " sq. km.")
                            print("Length of Waterway = " + str(distance3D_fin) + " m")
                            ...
                            final_alternatives.sort_values(["Net_Flow"], ascending=False, inplace=True)
                ...
                with arcpy.da.SearchCursor(inPoints, ["FID", "mem_point1", "Point_X", "Point_Y", "FAC", "DEM"], "FID = " + str(i)) as cursor1:
                    for row1 in cursor1:
                        ...
                        if total_alternatives == 0:
                            ...
                            print("Flow Accumulation = " + str(fac3) + " sq. km.")
                            print("Length of Waterway = " + str(distance3D_fin) + " m")
                            print("Q70 (cumecs) = " + str(Q70))
                            print("Hydropower Potential (MW) at Q70 = " + str(Hydro70) + " MW")
                            ...
                            print('subbasin_fin = '+ str(subbasin_fin))
                            print('flow_int_fin = '+ str(flow_int_fin))
                            FDC = FlowDurationCurve(river_folder, subbasin_fin, flow_int_fin, input_start_date, input_end_date, 'ALL')
                            Q10 = FDC[0]
                            Q20 = FDC[1]
                            Q30 = FDC[2]
...
#                                head_slope_fin = head_slope
                            ...
                            print("Head = " + str(head_fin) + " m")
                            print("Flow Accumulation = " + str(fac3) + " cells")
                            print("Length of Waterway = " + str(distance3D_fin) + " sq. km.")
                            print("Q70 (cumecs) = " + str(Q70))
                            print("Hydropower Potential (MW) at Q70 = " + str(Hydro70) + " MW")
...
if mode ==  "Appraoch (ii): Using both Topographic and Hydrological Factors (For use with WEB-DHM)":
    if flow_exceedance == 10:
...
results_df.index = np.arange(1, len(results_df)+1)
results_df = results_df.sort_values(['Net_Flow'], ascending = [False])
...
print("WDPA Intersections = " + str(WDPA_intersection_counter))
print("Rejected by Interference Tests = " + str(alternative_schemes_counter-final_schemes_counter))
#==============================================================================
